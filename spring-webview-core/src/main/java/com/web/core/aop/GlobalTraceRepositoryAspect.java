...
import com.web.core.aop.object.GlobalTraceCountObject;
...
public class GlobalTraceRepositoryAspect {
    ...
    //********************************************************************************************************
    @Around("execution(* com.web.infrastruture.repository.*.*(..))")
    public Object traceService(ProceedingJoinPoint joinPoint) throws Throwable {
        String typeTrace = "Repository";
