package com.web.core.aop.object;

import brave.Tracer;
import com.fasterxml.jackson.databind.ObjectWriter;
import com.web.core.configuration.utils.DateUtilsV8;
...
public class GlobalTraceUtils {
    ...
    private static int traceEventCountExecute(Map<String, GlobalTraceCountObject> mapRateNumb, String traceId) {
        if (mapRateNumb.get(traceId) == null) {
            mapRateNumb.put(traceId, new GlobalTraceCountObject(traceId, new AtomicInteger(0), new AtomicInteger(0), new Date(), false));
        }
